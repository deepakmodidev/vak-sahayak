      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <header className="fixed top-8 z-50 w-full max-w-6xl px-6">
          <div className="bg-white border border-border rounded-full px-8 py-3 flex items-center justify-between shadow-sm">
            ...
            <div className="flex items-center gap-3">
              <Link href="/" className="bg-[#111111] text-white px-6 py-2 rounded-full text-xs font-semibold hover:bg-black transition-all">
                Launch Portal
              </Link>
        ...
        <section className="pt-32 pb-16 flex flex-col items-center text-center px-6 max-w-6xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Link href="/" className="bg-[#111111] text-white px-10 py-4 rounded-full text-base font-semibold hover:bg-black transition-all shadow-md">
              Launch Voice Portal
            </Link>
